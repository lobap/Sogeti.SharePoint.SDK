...
<%@ Register TagPrefix="WebPartPages" Namespace="Microsoft.SharePoint.WebPartPages"
    Assembly="Microsoft.SharePoint, Version=12.0.0.0, Culture=neutral, PublicKeyToken=71e9bce111e9429c" %>
<%@ Register TagPrefix="PSS" Namespace="Contoso.PartnerPortal.PartnerCentral.WebParts.PartnerRollup" 
    Assembly="Contoso.PartnerPortal.PartnerCentral, Version=1.0.0.0, Culture=neutral, PublicKeyToken=019398de256d0b98" %>
                    ...
                    <tr>
                        <td valign="top" width="100%">
                            <WebPartPages:WebPartZone runat="server" FrameType="TitleBarOnly" ID="Left" Title="loc:Left">
                                <ZoneTemplate>
                                    <PSS:PartnerRollupWebPart runat="server" ID="PartnerRollupWebPart1" Description="Open Tasks in System" Title="Open Tasks in System" />
                                </ZoneTemplate>
